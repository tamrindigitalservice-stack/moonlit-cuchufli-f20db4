...
export const ServiceDetailModal: React.FC<ServiceDetailModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/80 backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[92vh] overflow-hidden flex flex-col border border-slate-200">
        ...
        {/* Modal Header */}
        <div
          className={`p-5 px-6 flex-shrink-0 flex items-start justify-between ${
            service.category === 'central'
              ? 'bg-gradient-to-r from-[#0F2C59] via-blue-900 to-[#0F2C59]'
        ...
        >
          ...
          <button
            ...
            onClick={onClose}
            id="close-modal-btn"
            className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center bg-white text-slate-900 border-2 border-slate-900 shadow-lg hover:bg-slate-100 active:scale-95 transition-all"
        ...
        {/* Modal Body */}
        <div className="p-5 sm:p-6 min-h-0 overflow-y-auto space-y-5 text-slate-700 text-sm">
          ...
          <div className="bg-amber-50/80 border border-amber-300 p-3.5 rounded-2xl text-xs text-amber-950 flex items-start gap-2.5">
            ...
            <p className="leading-relaxed">
              ...
              প্রয়োজনীয় নথি পরিষেবা অনুযায়ী পরিবর্তিত হতে পারে। আবেদন করার আগে আমাদের সাথে যোগাযোগ করুন।
            </p>
          </div>
        ...
        <div className="p-4 px-6 flex-shrink-0 bg-slate-50 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto">
            ...
            <a
              ...
              className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 bg-amber-400 hover:bg-amber-500 text-slate-950 font-bold text-xs py-2.5 px-4 rounded-xl transition-colors shadow-sm border border-amber-500"
            >
            ...
            <a
              ...
              className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs py-2.5 px-4 rounded-xl transition-colors shadow-md border border-emerald-700"
            >
